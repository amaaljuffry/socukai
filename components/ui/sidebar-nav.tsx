...
import { Calculator, CheckSquare, HelpCircle, Download, Check } from 'lucide-react';
  ...
  return (
    <>
      <div className="flex items-center pl-6 pt-6 pb-4">
        <Link href="/">
          <img src="/logo.svg" alt="SOCUKAI.MY Logo" className="h-8 w-auto opacity-90" />
        </Link>
      </div>
      ...
      <div className="mt-auto flex flex-col items-start py-6 pl-6">
        <Link href="/">
          <img src="/logo.svg" alt="SOCUKAI.MY Logo" className="h-8 w-auto opacity-80" />
        </Link>
        <span className="mt-2 text-[8px] text-muted-foreground">- 2025 ALL RIGHT RESERVED <p>POWERED BY PETAI.AGENCY</p></span>
      </div>
    </>
  );
} 